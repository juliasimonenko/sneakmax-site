...
export const validateForms = (selector, rules, afterSend) => {
  ...
  if (form.classList.contains('cart-modal__form')) {
    ...
    document.querySelectorAll('.cart-order__list .mini-cart__item').forEach((el, idx) => {
    ...
    productsFormData.append(`summ`, `${document.querySelector('.cart-order__summ span').textContent}`);
